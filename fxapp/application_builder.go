...
import (
	...
	loggerConfig "github.com/duongbui2002/core-package/logger/config"
...
func NewApplicationBuilder(environments ...environment.Environment) contracts2.ApplicationBuilder {
...
func (a *applicationBuilder) Build() contracts2.Application {
