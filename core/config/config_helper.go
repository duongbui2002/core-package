...
import (
	...
	environment2 "github.com/duongbuidinh600/core-package/core/config/environment"
...
func BindConfig[T any](environments ...environment2.Environment) (T, error) {
	return BindConfigKey[T]("", environments...)
}

func BindConfigKey[T any](
	configKey string,
	environments ...environment2.Environment,
) (T, error) {
	var configPath string

	currentEnv := environment2.Environment("")
	...
	if configPathFromEnv != "" {
		...
		if appRootPath == "" {
			appRootPath = environment2.GetProjectRootWorkingDirectory()
		}
