...
import (
	"emperror.dev/errors"
	problemDetails2 "github.com/duongbui2002/core-package/http/httperrors/problemdetails"
...
func ProblemDetailErrorHandlerFunc(
	...
	if !c.Response().Committed && problem != nil {
		...
		if _, err := problemDetails2.WriteTo(problem, c.Response()); err != nil {
			logger.Error(err)
		}
	}
}
