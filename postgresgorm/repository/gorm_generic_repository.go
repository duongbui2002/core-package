...
import (
	...
	"github.com/duongbui2002/core-package/http/httperrors/customerrors"
	"github.com/duongbui2002/core-package/mapper"
	gormPostgres "github.com/duongbui2002/core-package/postgresgorm/helpers/gormextensions"
	"github.com/duongbui2002/core-package/reflection/reflectionhelper"
	...
	if modelType == dataModelType {
		...
		if err := r.db.WithContext(ctx).First(&model, id).Error; err != nil {
			if errors.Is(err, gorm.ErrRecordNotFound) {
				return *new(TEntity), customErrors.customErrors.NewNotFoundErrorWrap(
					err,
					fmt.Sprintf(
